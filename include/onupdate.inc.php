 ...
 *
 * Modified to insert some common IP licenses and a default library collection to prepare the
 * module for immediate usage on installation. Also checks that an upload directory is available
